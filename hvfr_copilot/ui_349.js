...
/*                 const progressMessage = totalFiles > 1 
                ...
                //const progressMessage = `👁️ AI is reading the following document:<br>${chunk.fileName} - Part ${chunk.part} of ${chunk.totalParts}`;
              ...
              //session.fileContents = combinedResponses;
                ...
                for (const fileName of fileNames) {
                  ...
                  // Feldolgozási állapot frissítése
                  //const progressMessage = `👁️ AI is reading:<br>${chunk.fileName}`;
 ...
 */
            ...
            } else if (role === "assistant" || role === "perplexity") {
                htmlContent = marked.parse(message);        
        } else if (role === "system") {
