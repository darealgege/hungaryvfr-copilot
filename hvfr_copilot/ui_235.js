...
/*         try {
    ...
    const captureImage = () => {
        ...
        input.onchange = async (event) => {
            ...
            if (imageUrls.length > 0) {
                ...
                await waitForDOMUpdate();
                loadingMessageId = displayMessage(`🤖 The bot is thinking about the response...`, "system");
                await waitForDOMUpdate();
    ...
    const sendMessage = async () => {
        ...
        const loadingMessageId = displayMessage(`🤖 The bot is thinking about the response...`, "system");
